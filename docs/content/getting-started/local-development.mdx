...
Para detalhes, veja a [Referência de Arquitetura](../technical-reference/architecture.mdx).

Próximo passo: [Criar um plugin](../plugin-authoring/create-a-plugin.mdx) para montar seu primeiro plugin e rodá-lo com o MB.
